...
def recognize_face():
    ...
    while True:
        ...
        try:
            ...
            if faces:
                for face in faces:
                    x_left_bottom, y_left_bottom, width, height = face['box']
                    x_right_top = x_left_bottom + width
                    y_right_top = y_left_bottom + height
                    ...
                    cv2.putText(frame, f"{gender}", (x_left_bottom, y_left_bottom-10), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
